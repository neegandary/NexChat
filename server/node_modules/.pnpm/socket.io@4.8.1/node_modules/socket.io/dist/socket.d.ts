import { Packet } from ".pnpm/socket.io-parser@4.2.4/node_modules/socket.io-parser/build/esm";
...
import type { Room, Session, SocketId } from ".pnpm/socket.io-adapter@2.5.5/node_modules/socket.io-adapter/dist";
...
export declare class Socket<ListenEvents extends EventsMap = DefaultEventsMap, EmitEvents extends EventsMap = ListenEvents, ServerSideEvents extends EventsMap = DefaultEventsMap, SocketData = any> extends StrictEventEmitter<ListenEvents, EmitEvents, SocketReservedEventsMap> {
     ...
     * });
     */
    get conn(): import(".pnpm/engine.io@6.6.4/node_modules/engine.io/build/engine.io").Socket;
    /**
